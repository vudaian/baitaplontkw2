        ...
        <div class="header">
            <div class="header_top">
                ...
                <ul class="js-menu header_top-right m-9 c-3">
                    ...
                    <li class="header_top-right-item">
                        <a href="#" class="header_top-right-link">Trang chủ</a>
                    </li>
                    <li class="header_top-right-item">
                        <a href="#" class="header_top-right-link">Giới thiệu</a>
                    </li>
                    <li class="header_top-right-item">
                        <a href="./login.php" class="header_top-right-link">Đăng nhập</a>
                    </li>
                </ul>
                <ul class="header_top-left m-0 c-0">
                    ...
                    <li class="header_top-left-item">
                        <a href="#" class="header_top-left-link">
                            <i class="header_top-left-item-icon fab fa-google-plus-square"></i>
                        </a>
                    </li>
                </ul>
            ...
            <div class="header_center">
                <div class="header_center-logo l-3 m-12 c-12">
                    <img src="./assets/images/logo.png" alt="LOGO" class="header_center-logo-img">
                </div>
                <div class="header_center-search js-search-box l-9 ">
                    <form action="" method="" class="header_center-search-form">
                        <input type="text" class="header_center-seach-box" placeholder="Tìm kiếm...">
                        <button type="">
                            <i class="fas fa-search"></i>
                        </button>
                    </form>
        ...
        <div class="container">
            <div class="container__silde">
                <div class="slides-show">
                    <img class="mySlides" src="./assets/images/slide1.jpg">
                    <img class="mySlides" src="./assets/images/slide2.png">
                    <img class="mySlides" src="./assets/images/slide3.jpg">
