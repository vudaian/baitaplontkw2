...
<body>
    <div class="around">
        ...
        <div class="around_right l-10 m-12 c-12">
            ...
            <h1 class="around_right-title">Bạn muốn sửa tin mới!</h1>
            <?php
            ...
            <form action="" class="form-add" method="POST">
                <div class="form-add__td">
                    ...
                    <input type="text" placeholder="Điền tiêu đề tại đây..." value="<?php echo $titlenew; ?>" name="titlenew">
                </div>
                <div class="form-add__img">
                    <label for="">Ảnh(<span>*</span>)</label>
                    <input type="text" placeholder="Gán link ảnh tại đây..." name="imagenew">
                </div>
                <div class="form-add__time">
                    <label for="">Thời gian(<span>*</span>)</label> 
                    <input type="text" placeholder="Điền thời gian tại đây.." name="timenew">
                </div>
                <div class="form-add__nd">
                    <label for="">Chi tiết tin(<span>*</span>)</label>
                    <input type="text" placeholder="Hãy điền nội dung tin..." name="detailsnew">
                </div>
                <div class="btn">
