    ...
    <div class="app grid wide">
      ...
      <div class="main">
        <div class="main__content">
            ...
            ?>
          <div class="time">
            <p class="main__content__time"><i><?php echo $result['timenew'];?></i></p>
          </div>
          <h1 class="main__content-title">
            <?php echo $result['titlenew']; ?>
          </h1>
          <div class="content-img">
            <img
              src="<?php echo $result['imagenew']; ?>"
              alt="anh bong da"
        ...
        <div class="main__comment">
          ...
          <div class="main__content__users">
            <form action="http://localhost/The news/index_news.php?ID=<?php echo $ID;?>" method="POST" style="width: 100%; display: flex;"> 
              <input
                type="text"
