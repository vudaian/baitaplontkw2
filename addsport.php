    ...
    <div class="around">
        <div class="around_left l-2 m-0 c-0">
            ...
            <div class="around_left-item">
                ...
                <p><a href="./addnews.php">Tin mới</a></p>
            </div>
            ...
            <div class="around_left-item">
                ...
                <p><a href="#">Tin thời trang</a></p>
            </div>
            <div class="around_left-item">
                <i class="fas fa-fire"></i>
                <p><a href="#">Tin nóng</a></p>
            </div>
        </div>
        <div class="around_right l-10 m-12 c-12">
            ...
            <h1 class="around_right-title">Hãy thêm tin thể thao!</h1>
            <?php
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    if ($title == "" || $image == "" || $time == "" || $details == "") {
                        ...
                        if ($conn->query($sql) === TRUE) {
                            echo '<script language="javascript">alert("Đã thêm tin thể thao!"); window.location="addsport.php";</script>';
                        } else {
            ...
            ?>
            <form action="addsport.php" class="form-add" method="POST">
